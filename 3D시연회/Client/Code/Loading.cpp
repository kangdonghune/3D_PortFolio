...
Engine::_uint CLoading::LoadingForStage(void)
{
	...
	FAILED_CHECK_RETURN(Ready_Proto(L"Proto_Mesh_AK47", CStaticMesh::Create(m_pGraphicDev, L"../../Resource/Staticmesh/Weapon/", L"M4.X")), E_FAIL);
	...
	//오브젝트
	FAILED_CHECK_RETURN(Ready_Proto(L"Proto_Mesh_House", CStaticMesh::Create(m_pGraphicDev, L"../../Resource/Staticmesh/Building/House/HouseDefault/", L"HouseDefault2FNW.X")), E_FAIL);
