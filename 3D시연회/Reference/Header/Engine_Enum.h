...
namespace Engine
{
	...
	enum LIGHT		{ DIRECTION, SPOT, POINT_MUZZLE, POINT1, POINT2, POINT3, LIGHT_END};
	...
	enum RENDERID { RENDER_PRIORITY, RENDER_NONALPHA, RENDER_ALPHA, RENDER_NONSPECULAR, RENDER_SPECULAR,RENDER_UI, RENDER_DEBUG, RENDER_END };
