...
BOOL CMainFrame::OnCreateClient(LPCREATESTRUCT lpcs, CCreateContext* pContext)
{
	...
	m_MainSplitter.CreateView(0, 0, RUNTIME_CLASS(CForm), CSize(FORMCX, FORMCY), pContext);
	m_MainSplitter.CreateView(0, 1, RUNTIME_CLASS(CMFCView), CSize(WINCX, WINCY), pContext);
